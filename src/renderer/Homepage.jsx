  ...
  const sidebarContent = (
    ...
    >
      <List component="nav" sx={{ p: 2 }}>
        ...
        {userInfo && userInfo.connectedServices && userInfo.connectedServices.spotify && (
          <>
            {/* Spotify Dropdown */}
            <ListItem
              button
        ...
        {userInfo && userInfo.connectedServices && userInfo.connectedServices.appleMusic && (
          <>
         ...
         !userInfo.connectedServices.appleMusic && (
          <Box sx={{ p: 2, textAlign: 'center' }}>
            <Typography variant="body2" color="text.secondary">
              ...
              Please go to Settings to connect a service.
            </Typography>
          </Box>
        )}
      </List>
