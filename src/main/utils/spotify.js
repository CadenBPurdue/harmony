...
class SpotifyApi {
  ...
  async getPlaylist(id) {
    ...
    try {
      ...
      console.log(`[SpotifyApi] Retrieved a total of ${allTracks.length} tracks for playlist ${id}`);
      ...
      console.error(`[SpotifyApi] Error fetching playlist ${id}:`, error.response?.data || error.message);
